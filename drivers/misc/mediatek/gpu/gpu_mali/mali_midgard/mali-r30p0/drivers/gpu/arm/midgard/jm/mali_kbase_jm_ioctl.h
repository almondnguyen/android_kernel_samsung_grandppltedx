 ...
 *   'scheduling'.
 * 11.15:
 * - Deleted files "mem_pool_max_size", "mem_pool_size", "lp_mem_pool_max_size",
 *   "lp_mem_pool_size".
 * - Add a new sub-directory "mempool", and 3 new files inside
 *   1. "max_size": Replaced "mem_pool_max_size", "mem_pool_size"
 *   2. "lp_max_size": Replaced "lp_mem_pool_max_size", "lp_mem_pool_size"
 *   3. "ctx_max_size"
 */
#define BASE_UK_VERSION_MAJOR 11
#define BASE_UK_VERSION_MINOR 15
