...
#define CCCI_IOC_ENTER_UPLOAD		_IO(CCCI_IOC_MAGIC, 60) /* modem log */
#define CCCI_IOC_ENTER_UPLOAD2		_IO(CCCI_IOC_MAGIC, 61) /* modem log */
#define CCCI_IOC_FORCE_MD_OFF		_IO(CCCI_IOC_MAGIC, 62) /* factory for s */
...
/* TEST_MESSAGE_FOR_BRINGUP */
	...
	/* MIPI */
	MD_DISPLAY_DYNAMIC_MIPI_2G = 0x11f,
	MD_DISPLAY_DYNAMIC_MIPI_3G = 0x120,
	MD_DISPLAY_DYNAMIC_MIPI_4G = 0x121,

	/* Thermal low pwer */
	MD_THERMAL_LOW_POWER = 0x122,
