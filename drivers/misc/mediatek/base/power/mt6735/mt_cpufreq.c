...
static struct mt_cpu_freq_info opp_tbl_e1_3[] = {
	...
	OP(CPU_DVFS_FREQ0,  114000),
	OP(CPU_DVFS_FREQ1,  111500),
	OP(CPU_DVFS_FREQ3,  109500),
	OP(CPU_DVFS_FREQ4,  107000),
	OP(CPU_DVFS_FREQ5,  104500),
	OP(CPU_DVFS_FREQ5_1p1, 102000),
	OP(CPU_DVFS_FREQ6,  97500),
	OP(CPU_DVFS_FREQ8,  95000),
#else
	OP(CPU_DVFS_FREQ0,  114000),
	OP(CPU_DVFS_FREQ1,  111500),
	...
	OP(CPU_DVFS_FREQ4,  107000),
	OP(CPU_DVFS_FREQ5,  104500),
	OP(CPU_DVFS_FREQ6,  102000),
	OP(CPU_DVFS_FREQ7,  97500),
	OP(CPU_DVFS_FREQ8,  95000),
#endif
};
